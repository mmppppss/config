...
map('n', '<F4>t', ':ToggleTerm direction=float<CR>')
map('t', '<F4>t', '<C-\\><C-n>:ToggleTerm<CR>')
...
map('n', '<F5>a',':vsp | set nonu | set nornu | terminal ./gradlew assembleDebug<CR>')
map('n', '<F5>i',':vsp | set nonu | set nornu | terminal ./gradlew installDebug<CR>')
map('n', 'gj',':JsDoc <CR>')
